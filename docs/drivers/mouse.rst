...
console's scrollback (see `console.rst <console.rst>`_). It deliberately ignores
...
- `console.rst <console.rst>`_ — ``scrollUpBy`` / ``scrollDownBy``, driven by the wheel.
- `keyboard.rst <keyboard.rst>`_ — shares the same 8042 controller.
